...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder './', "/vagrant", type: "rsync",
    rsync__exclude: [".git/", "resources/", "generator/", "solver/", "tests/"]
  config.vm.synced_folder './resources/', "/vagrant/resources/"
  config.vm.synced_folder './generator/', "/vagrant/generator/"
  config.vm.synced_folder './solver/', "/vagrant/solver/"
